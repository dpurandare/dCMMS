    ...
    const templates = [
        {
            ...
            description: 'Visual inspection of turbine blades for cracks, erosion, or lightning damage.',
            ...
            safety_requirements: JSON.stringify(['harness', 'helmet', 'wind_speed_limit_10ms']),
        ...
        },
        {
            ...
            description: 'Complete oil change and filter replacement for main gearbox.',
            ...
            required_skills: JSON.stringify(['mechanical_maintenance', 'hazardous_materials_handling']),
            safety_requirements: JSON.stringify(['gloves', 'eye_protection', 'spill_kit']),
            typical_parts: JSON.stringify([
        ...
        },
        {
            ...
            required_skills: JSON.stringify(['electrical_maintenance', 'high_voltage_safety']),
        ...
        },
        {
            ...
            required_skills: JSON.stringify(['electrical_maintenance', 'thermography']),
            safety_requirements: JSON.stringify(['arc_flash_suit', 'lockout_tagout']),
            typical_parts: JSON.stringify([]),
            frequency_days: 365,
            frequency_description: 'Annual',
