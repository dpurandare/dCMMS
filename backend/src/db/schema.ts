...
export const refreshTokens = pgTable("refresh_tokens", {
  ...
  replacedByTokenId: uuid("replaced_by_token_id").references((): any => refreshTokens.id, {
    onDelete: "set null",
  }),
...
export const assetHealthScores = pgTable("asset_health_scores", {
  ...
  daysSinceLastMaintenance: integer("days_since_last_maintenance")
    .notNull()
    .default(0),
...
export const complianceReportTemplates = pgTable(
  "compliance_report_templates",
  {
    ...
    complianceStandard: varchar("compliance_standard", {
      length: 100,
    }).notNull(),
...
export const complianceGeneratedReports = pgTable(
  "compliance_generated_reports",
  {
    ...
    templateId: uuid("template_id")
      .notNull()
      .references(() => complianceReportTemplates.id, { onDelete: "cascade" }),
...
export const generationForecasts = pgTable("generation_forecasts", {
  ...
  // Forecast values
  predictedGenerationMw: decimal("predicted_generation_mw", {
    precision: 10,
    scale: 3,
  }).notNull(),
  confidenceIntervalLowerMw: decimal("confidence_interval_lower_mw", {
    precision: 10,
    scale: 3,
  }),
  confidenceIntervalUpperMw: decimal("confidence_interval_upper_mw", {
    precision: 10,
    scale: 3,
  }),
  ...
  actualGenerationMw: decimal("actual_generation_mw", {
    precision: 10,
    scale: 3,
  }),
  ...
  // Weather inputs
  weatherForecastId: uuid("weather_forecast_id").references(
    () => weatherForecasts.id,
    { onDelete: "set null" },
  ),
  ...
  // Model metadata
  modelAccuracyScore: decimal("model_accuracy_score", {
    precision: 5,
    scale: 4,
  }),
...
export const forecastAccuracyMetrics = pgTable("forecast_accuracy_metrics", {
  ...
  // Accuracy metrics
  meanAbsoluteErrorMw: decimal("mean_absolute_error_mw", {
    precision: 10,
    scale: 3,
  }),
  meanAbsolutePercentageError: decimal("mean_absolute_percentage_error", {
    precision: 5,
    scale: 2,
  }),
  rootMeanSquaredErrorMw: decimal("root_mean_squared_error_mw", {
    precision: 10,
    scale: 3,
  }),
  rSquared: decimal("r_squared", { precision: 5, scale: 4 }),
  forecastSkillScore: decimal("forecast_skill_score", {
    precision: 5,
    scale: 4,
  }),
...
export const windTurbineMetadata = pgTable("wind_turbine_metadata", {
  ...
  cutOutWindSpeedMs: decimal("cut_out_wind_speed_ms", {
    precision: 5,
    scale: 2,
  }),
  ...
  generatorRatedPowerMw: decimal("generator_rated_power_mw", {
    precision: 6,
    scale: 3,
  }),
  generatorVoltageKv: decimal("generator_voltage_kv", {
    precision: 6,
    scale: 2,
  }),
  ...
  availabilityTarget: decimal("availability_target", {
    precision: 5,
    scale: 4,
  }),
  ...
  maxWindSpeedSurvivalMs: decimal("max_wind_speed_survival_ms", {
    precision: 6,
    scale: 2,
  }),
...
export const assetHealthScoresRelations = relations(
  assetHealthScores,
  ({ one }) => ({
    asset: one(assets, {
...
export const complianceReportTemplatesRelations = relations(
...
export const complianceGeneratedReportsRelations = relations(
  complianceGeneratedReports,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const generationForecastsRelations = relations(
  generationForecasts,
  ({ one }) => ({
    site: one(sites, {
...
export const forecastAccuracyMetricsRelations = relations(
...
export const windTurbineMetadataRelations = relations(
  windTurbineMetadata,
  ({ one }) => ({
    asset: one(assets, {
...
export const windWorkOrderTemplatesRelations = relations(
  windWorkOrderTemplates,
  ({ one }) => ({
    tenant: one(tenants, {
