  ...
  server.patch(
    ...
    async (request, reply) => {
      try {
        ...
        if (
          error.message.includes("auto-calculated") ||
  ...
  server.get(
    ...
    async (request, reply) => {
      try {
        ...
        const rates = await costService.getLaborRates(
  ...
  server.put(
    ...
    async (request, reply) => {
      try {
        ...
        const laborRate = await costService.updateLaborRate(
          role,
          hourlyRate,
          updatedBy,
        );
  ...
  server.get(
    ...
    async (request, reply) => {
      try {
        ...
        const rates = await costService.getEquipmentRates(
          includeExpired === true || includeExpired === "true",
        );
